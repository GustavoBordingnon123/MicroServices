...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\Micro\\Desktop\\project-root\\microservices\\login-service\\generated\\login-service-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\Micro\\Desktop\\project-root\\microservices\\login-service\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "// login-service/prisma/schema.prisma\n\ngenerator client {\n  provider = \"prisma-client-js\"\n  output   = \"../generated/login-service-client\"\n}\n\ndatasource db {\n  provider = \"mysql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  password  String\n  createdAt DateTime @default(now())\n}\n",
  "inlineSchemaHash": "36b39632f06a518fc72ef885b0c1633a28151c9a926b4aad73ce1c7f4bbf33cb",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "generated/login-service-client",
...
path.join(process.cwd(), "generated/login-service-client/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "generated/login-service-client/schema.prisma")
